...
namespace TygaSoft.Web
{
    public partial class Login : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                if (Request.Cookies["UserInfo"] != null)
                {
                    ...
                    {
                        ltrMyData.Text = "<div id=\"myData\" style=\"display:none;\">[{\"UserName\":\"" + Server.HtmlEncode(userName) + "\"}]</div>";
                    }
                }
            }
            else
        ...
        private void OnLogin()
        {
            ...
            if (sVc.ToLower() != Request.Cookies["ValidateCode"]["LoginVc"].ToLower())
            {
            ...
            if (isRemember)
            {
                ...
                Response.Cookies["UserInfo"].Expires = DateTime.Now.AddYears(2);
            }
