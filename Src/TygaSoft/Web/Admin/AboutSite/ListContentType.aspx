<%@ Page Title="内容类型列表" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListContentType.aspx.cs" Inherits="TygaSoft.Web.Admin.ListContentType" %>
...
<div id="dlg" class="easyui-dialog" title="新建/编辑内容类型" data-options="iconCls:'icon-save',closed:true,modal:true,
href:'/Templates/Admin/AddContentType.htm',buttons: [{
    ...
    }]" style="width:447px;height:300px;padding:10px">
