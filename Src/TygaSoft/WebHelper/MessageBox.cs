...
namespace TygaSoft.WebHelper
{
    public class MessageBox
    {
        ...
        /// <param name="control"></param>
        /// <param name="msg"></param>
        public static void Show(Page page, Control control, string msg)
        {
            msg = msg.Replace(@"'", @"“");
            ClientScriptManager csm = page.ClientScript;
            csm.RegisterClientScriptBlock(control.GetType(), control.ClientID, string.Format(@"alert('{0}')",msg), true);
        }
