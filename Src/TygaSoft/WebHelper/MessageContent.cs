...
namespace TygaSoft.WebHelper
{
    public static class MessageContent
    {
        ...
        public const string Request_DateTime_CompareToError = "{0}不能大于{1}，请检查！";
        public const string Request_InvalidPassword = "密码正确格式由数字或字母组成的字符串，且最小6位，最大30位！";
        public const string Request_InvalidValue = "{0}输入不正确，请检查！";
        public const string Request_InvalidArgument = "获取{0}的值为空字符串或格式不正确，请检查！";
        public const string Request_Data_Invalid = "{0}不存在或已被删除，请检查！";
