...
namespace TygaSoft.CustomProvider
{
    public class MsSqlMembershipProvider : MembershipProvider
    {
        ...
        public override bool ChangePassword(string username, string oldPassword, string newPassword)
        {
            ...
            SqlHelper.ExecuteNonQuery(_sqlConnectionString, CommandType.StoredProcedure, "dbo.aspnet_Membership_SetPassword", parms);
        ...
        public override bool DeleteUser(string username, bool deleteAllRelatedData)
        {
            ...
            SqlHelper.ExecuteNonQuery(_sqlConnectionString, CommandType.StoredProcedure, cmdText, parms.ToArray());
        ...
        public override MembershipUserCollection GetAllUsers(int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(_sqlConnectionString, CommandType.StoredProcedure, cmdText, parms))
            {
        ...
        public override int GetNumberOfUsersOnline()
        {
            ...
            parms[0].Direction = ParameterDirection.ReturnValue;
            SqlHelper.ExecuteNonQuery(_sqlConnectionString, CommandType.StoredProcedure, "dbo.aspnet_Membership_GetNumberOfUsersOnline", parms);
        ...
        public override bool UnlockUser(string userName)
        {
            ...
            parms[0].Direction = ParameterDirection.ReturnValue;
            SqlHelper.ExecuteNonQuery(_sqlConnectionString, CommandType.StoredProcedure, cmdText, parms);
        ...
        public override void UpdateUser(MembershipUser user)
        {
            ...
            SqlParameter[] parms = {
                                       ...
                                       CreateInputParam("@UniqueEmail", SqlDbType.Bit, RequiresUniqueEmail ? 1 : 0),
                                       CreateInputParam("@CurrentTimeUtc", SqlDbType.DateTime, DateTime.Now)
                                   };
            parms[0].Direction = ParameterDirection.ReturnValue;
            SqlHelper.ExecuteNonQuery(_sqlConnectionString, CommandType.StoredProcedure, cmdText, parms);
